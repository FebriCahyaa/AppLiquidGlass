...
class _GlassShellState extends State<GlassShell> {
  ...
  final pages = const [
    (
      'Discover your flow.',
      'A calm space for ideas, tasks, and inspiration.',
      'Beautifully adaptive.',
      'Translucent surfaces, soft depth, and expressive motion designed for Flutter.'
    ),
    (
      'Explore new ideas.',
      'Browse concepts and discover something unexpected.',
      'A wider perspective.',
      'A flexible visual language for dashboards, feeds, and creative experiences.'
    ),
    (
      'Your activity.',
      'Keep track of what matters and see your progress.',
      'Small steps, real momentum.',
      'Clear hierarchy and gentle motion help you stay focused.'
    ),
    (
      'Make it yours.',
      'Tune the experience, appearance, and interaction style.',
      'Personal by design.',
      'A reusable foundation with adaptable colors and native gestures.'
    ),
  ];
              ...
              Expanded(
                child: GestureDetector(
                  onHorizontalDragEnd: (details) {
                    ...
                    if (velocity < -100)
                      setState(() => selected = (selected + 1).clamp(0, 3));
                    if (velocity > 100)
                      setState(() => selected = (selected - 1).clamp(0, 3));
                  },
                  child: AnimatedSwitcher(
                    ...
                    child: _GlassPage(
                        key: ValueKey(selected), data: data, dark: dark),
                  ),
                ),
              ),
              _GlassNavigation(
            ...
            child: BackdropFilter(
              ...
              child: Container(
                ...
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('LIQUID GLASS SYSTEM',
                          style: TextStyle(
                              color: violet,
...
class _GlassNavigation extends StatelessWidget {
  const _GlassNavigation(
      {required this.selected, required this.onSelected, required this.dark});
  final int selected;
